...
export default class StoryScreen extends Component {
  ...
  async initiateTTS(title, author, story, moral) {
    ...
    if (current_color === "gray") {
      ...
      Speech.speak(story);
      Speech.speak("The practical implications of project are, ");
      Speech.speak(moral);
    } else {
      Speech.stop();
    }
      ...
      return (
        ...
        >
          ...
          <View style={styles.storyContainer}>
            ...
            >
              <Image
                source={{uri:this.props.route.params.story.preview_image._W}}
                style={styles.image}
              ></Image>
              ...
              <View style={styles.storyTextContainer}>
                ...
                >
                  Practical implication- {this.props.route.params.story.moral}
                </Text>
              </View>
