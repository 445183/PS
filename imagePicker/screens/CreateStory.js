...
export default class CreateStory extends Component {
  ...
  getImage=async()=>{
    ...
    if(!result.cancelled){
      ...
      let url=uploadImageAsync(this.state.image);
      ...
      return (
        ...
        >
          ...
          <View style={styles.fieldsContainer}>
            <ScrollView>
              <Image
                source={this.state.image!==''?{uri:this.state.image}:require('../assets/arduino.jpg')}
              ...
              <View style={{ height: RFValue(this.state.dropdownHeight) }}>
                ...
                >
                  <Text style={this.state.light_theme?styles.seltonText:styles.seltonTextDark}>Select Image from here !</Text>
                </TouchableOpacity>
              </View>
